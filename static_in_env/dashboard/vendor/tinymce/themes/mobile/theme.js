...
(function () {
        ...
        return getDocFromFrame(frame).bind(function (doc) {
          return getWinFromFrame(frame).map(function (win) {
            ...
            return {
              ...
              MarketplaceContent: editor.MarketplaceContent,
    ...
    var monitor = function (editorApi) {
      var tapEvent = monitor$1({
        triggerEvent: function (type, evt) {
          editorApi.MarketplaceContent(evt);
        }
      });
    ...
    var MobileSchema = objOf([
      requiredObjOf('editor', [
        ...
        defaulted('MarketplaceContent', noop),
    ...
    var produce$1 = function (raw) {
      ...
      var mask = build$1(sketch(Marketplace, mobile.translate));
        ...
        editor.on('init', function () {
          realm.init({
            editor: {
              ...
              MarketplaceContent: function (evt) {
